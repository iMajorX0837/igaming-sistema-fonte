...
```bash
cd /opt/venuzbet
git checkout Deploy-Infra/docker-compose.yml
git pull
```
...
```bash
git checkout -- Deploy-Infra/docker-compose.yml Deploy-Infra/scripts/add-tenant.sh
git pull
```
