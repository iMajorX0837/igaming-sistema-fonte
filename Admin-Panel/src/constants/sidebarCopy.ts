  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        hint: 'Texto em destaque. Equivalente ao layout "Duas linhas" dos cards.',
      },
    ],
  },
];

function mergeCopyLang(lang: SidebarLanguage, partial?: Partial<SidebarCopy> | null): SidebarCopy {
...
export const SIDEBAR_LANGUAGE_LABELS: Record<SidebarLanguage, string> = {
  pt: 'Português',
  en: 'English',
  es: 'Español',
};
