    ...
    try {
      ...
      if (error) {
        ...
        showToastRef.current(
          'Erro ao carregar usuário. Execute Deploy-Infra/supabase_nova_casa.sql no Supabase.',
          'error',
        );
        return;
      }
  ...
  const loadIndicacao = useCallback(async () => {
    ...
    try {
      ...
      if (error) {
        console.error(error);
        showToastRef.current(
          'Erro ao carregar Indique e Ganhe. Execute Deploy-Infra/supabase_nova_casa.sql no Supabase.',
          'error',
        );
        return;
      }
